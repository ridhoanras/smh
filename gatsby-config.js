module.exports = {
  ...
  siteMetadata: {
    author: 'Sekolah Mutiara Hati',
    description: '',
    siteUrl: 'https://knightjdr.github.io/gatsby-starter-scientist',
    title: 'Sekolah Mutiara Hati',
    // List of link buttons to include on the landing image. Delete this field
    // and/or all entires if you do not want these links.
    // options: 'contact', 'registration', 'about', 'blog', 'stage'
    primaryLinks: [
      'stage',
      'registration',
    ],
    // List of PubMed IDs to include on the blog page. Delete this field
    // and/or all entires if you do not want the blog page.
    blog: [
      31217594,
      30554943,
      29395067,
